...
export function ActionBadge({
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center gap-1 justify-center rounded-md border px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider',
...
export function GradeBadge({ grade }: { grade: string }) {
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center justify-center rounded-md border px-1.5 py-0.5 font-[family-name:var(--font-display)] text-[11px] font-black leading-none',
