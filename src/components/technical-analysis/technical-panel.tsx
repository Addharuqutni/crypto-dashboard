    ...
    >
      ...
      <div>
        <p className="text-sm font-semibold capitalize">
          {symbol} —{' '}
          {trend.value === 'insufficient_data' ? 'Insufficient Data' : `${trend.value} Bias`}
        </p>
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="numeric text-sm font-medium text-text-secondary">
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="numeric text-sm text-text-secondary">{formatCurrency(avgVolume)}</span>
      </div>
      <div className="flex items-center justify-between">
