  ...
  if (items.length === 0) {
    return (
      <div className="card px-4 py-6 text-center">
        <Star className="mx-auto h-6 w-6 text-text-muted/60" aria-hidden="true" />
        <p className="mt-2.5 text-sm font-medium text-text-primary">No coins in your watchlist</p>
  ...
  return (
    <div className="card overflow-hidden">
      <div className="flex items-center justify-between border-b border-border-subtle px-4 py-2.5">
        ...
        <Link
          href="/watchlist"
          className="inline-flex items-center gap-1 text-xs font-medium text-text-secondary hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring"
        >
          View all
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2.5">
                <span className="flex h-6 w-6 items-center justify-center rounded-full border border-border-subtle bg-bg-surface text-[9px] font-bold text-accent-primary">
